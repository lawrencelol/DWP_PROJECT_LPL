...
if ($prevTotalSales != 0) {
    ...
    $salesChange = 'No Changes'; // Handle case where previous total sales are zero
}
...
if ($prevTotalOrders != 0) {
    ...
    $ordersChange = 'No Changes'; // Handle case where previous total orders are zero
}
...
if ($prevTotalRates != 0) {
    ...
    $ratesChange = 'No Changes'; // Handle case where previous total rates are zero
}
...
if ($prevTotalComments != 0) {
    ...
    $commentsChange = 'No Changes'; // Handle case where previous total comments are zero
}
?>
